 ...
 */
public class LoadingDialog_cellect {
    private Dialog progDialog = null;

    private static LoadingDialog_cellect loadingDialog;

    public static LoadingDialog_cellect getInstance() {
