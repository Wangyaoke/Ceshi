 ...
 */
public class WheelDialogFragment2 extends BaseDialogFragment implements WheelView.OnValueChangeListener {
    ...
    protected int getLayoutID() {
        return R.layout.view_dialog_wheel1;
    }
    ...
    protected void initEvent() {
        ...
        tvLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onWheelDialogListener != null) {
                    onWheelDialogListener.onClickLeft(WheelDialogFragment2.this, getWheelValue());
                }
            }
        });
        ...
        tvRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onWheelDialogListener != null) {
                    onWheelDialogListener.onClickRight(WheelDialogFragment2.this, getWheelValue());
                }
            }
        });
            ...
            public void onValueChange(WheelView picker, int oldVal, int newVal) {
                try {
                    ...
                    if (content != null && onWheelDialogListener != null) {
                        onWheelDialogListener.onValueChange(WheelDialogFragment2.this, content[newVal - wheelView.getMinValue()]);
                    }
                }
                catch (Exception e)
                {
