 ...
 */
public class LoadingDialog_tj {
    private Dialog progDialog = null;

    private static LoadingDialog_tj loadingDialog;

    public static LoadingDialog_tj getInstance() {
    ...
    public void showDialog() {
        ...
        progDialog.setContentView(R.layout.loading_dialog_tj);
