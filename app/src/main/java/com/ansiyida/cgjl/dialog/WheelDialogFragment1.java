 ...
 */
public class WheelDialogFragment1 extends BaseDialogFragment implements WheelView.OnValueChangeListener {
    ...
    protected void initEvent() {
        ...
        tvLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onWheelDialogListener != null) {
                    onWheelDialogListener.onClickLeft(WheelDialogFragment1.this, getWheelValue());
                }
            }
        });
        ...
        tvRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onWheelDialogListener != null) {
                    onWheelDialogListener.onClickRight(WheelDialogFragment1.this, getWheelValue());
                }
            }
        });
            ...
            public void onValueChange(WheelView picker, int oldVal, int newVal) {
                try {
                    ...
                    if (content != null && onWheelDialogListener != null) {
                        onWheelDialogListener.onValueChange(WheelDialogFragment1.this, content[newVal - wheelView.getMinValue()]);
                    }
                }
                catch (Exception e)
                {
