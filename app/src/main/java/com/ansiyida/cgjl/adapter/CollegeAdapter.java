...
public class CollegeAdapter extends RecyclerView.Adapter {
    ...
    public CollegeAdapter(ICollegeActivity iCollegeActivity, ArrayList<CollegeBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof TimeViewHolder) {
                    ...
                    if (list.get(0).getEdit()) {
                        ...
                        switch (collegeBean.getType()){
                            ...
                            case "D"://研讨
                                ...
                                intent.putExtra("jc_id",collegeBean.getId());
                                context.startActivity(intent);
                                break;
                        }
                    }
            ...
            if (imgUrl!=null){
                Glide.with(context.getApplicationContext()).load(imgUrl).centerCrop().into(viewHolder.image);
            }else {
                Glide.with(context.getApplicationContext()).load("").centerCrop().into(viewHolder.image);
    ...
    public void deleteItem() {
        ...
        if (lenth > 0) {
            ...
            Call<DefaultBean> call= MyApplication.getNetApi().cancelCollege((String) SharedPreferenceUtils.get(context,"app_token",""),sb.toString());
