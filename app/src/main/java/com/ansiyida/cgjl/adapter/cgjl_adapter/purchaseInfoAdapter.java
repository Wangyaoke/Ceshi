...
public class purchaseInfoAdapter extends RecyclerView.Adapter<purchaseInfoAdapter.ViewHolder> {

    private List<caigoulist.DataBean> list;
    private Context context;
    private String TIME="";
    private List<caigoulist.DataBean>childList = new ArrayList<>();
    private List<String> IdList = new ArrayList<>();
    private List<String> ll = new ArrayList<>();
    private List< List<caigoulist.DataBean>> LIST = new ArrayList<>();
    private List<caigoulist.DataBean> listt;

    public purchaseInfoAdapter(List<caigoulist.DataBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        purchaseInfoChildAdapter purchaseInfoChildAdapter = new purchaseInfoChildAdapter(LIST.get(position));
        holder.purchaseinfoRecycler.setLayoutManager(new LinearLayoutManager(context));
        holder.purchaseinfoRecycler.setAdapter(purchaseInfoChildAdapter);
