...
public class WheelView_qy extends View {
    ...
    public interface OnValueChangeListener{
        void onValueChange(WheelView_qy picker, int oldVal, int newVal);
    }

    public interface OnValueChangeListenerRelativeToRaw{
        void onValueChangeRelativeToRaw(WheelView_qy picker, int oldPickedIndex, int newPickedIndex, String[] displayedValues);
    }
    ...
    public interface OnScrollListener {
        ...
        void onScrollStateChange(WheelView_qy view, int scrollState);
    }
    ...
    public WheelView_qy(Context context) {
        this(context, null);
    }
    public WheelView_qy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public WheelView_qy(Context context, AttributeSet attrs, int defStyleAttr) {
                        ...
                        if(msg.arg1 != msg.arg2){
                            if(msg.obj == null || !(msg.obj instanceof Boolean) || (Boolean) msg.obj) {
                                if(mOnValueChangeListener != null) {
                                    mOnValueChangeListener.onValueChange(WheelView_qy.this, msg.arg1 + mMinValue, msg.arg2 + mMinValue);
                                }
                                if(mOnValueChangeListenerRaw != null){
                                    mOnValueChangeListenerRaw.onValueChangeRelativeToRaw(WheelView_qy.this, msg.arg1, msg.arg2, mDisplayedValues);
                                }
                            }
                        }
