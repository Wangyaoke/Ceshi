...
import com.ansiyida.cgjl.listener.IVerticalProgress;
...
public class VerticalProgress extends View implements IVerticalProgress {
    ...
    private int mHalationColor =Color.YELLOW; // 光晕的颜色
    private int mBackGroundColor = Color.parseColor("#FFEC1737"); // 进度条背景颜色
    protected float mRadius; // 圆的半径
    private float mDividerLength; // 圆的间距
    private int mMaxPointCount = 0; // 圆点数量
    private int mCurrentPoint = 0; // 当前到达的位置
    ...
    private float mHalationWidthTimes = 2.0f;// 光晕相对于圆点的大小，倍数。
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //mMeasuredWidth / 2 / mHalationWidthTimes
        if(mRadius == 0) {
            mRadius = (20);
        }
    ...
    public void initView(Context context, @Nullable AttributeSet attrs) {
        ...
        // 直线宽
        mVerticalLineWidth =px2dp(mContext,5);
