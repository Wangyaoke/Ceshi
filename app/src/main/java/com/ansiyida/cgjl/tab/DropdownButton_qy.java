 ...
 */
public class DropdownButton_qy extends RelativeLayout implements Checkable, View.OnClickListener, PopWinDownUtil_qy.OnDismissLisener, AdapterView.OnItemClickListener {
    /**
     * 菜单按钮文字内容
     */
  ...
  //  private EditText  edittext_class;
    ...
    private PopWinDownUtil_qy popWinDownUtil;
    ...
    public DropdownButton_qy(Context context) {
        this(context, null);
    }

    public DropdownButton_qy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DropdownButton_qy(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param dropBeans
     */
    public void setData(List<DropBean> dropBeans,String name,TextView title){
        if(dropBeans == null)
            return;
      ...
      //  edittext_class=edittitle;
       ...
       // text.setText(drops.get(0).getName());
        text.setText(name);
        selectPosition = 0;
        View view = LayoutInflater.from(mContext).inflate(R.layout.dropdown_content_qy, null);
      //  view.findViewById(R.id.content1).getBackground().setAlpha(100);//0~255透明度值
        ...
        int width = line.getMeasuredWidth();
        popWinDownUtil = new PopWinDownUtil_qy(mContext,view,line, width,height);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
           ...
           // iv=viewHolder.dismiss;
            if(convertView == null){
                ...
                convertView = LayoutInflater.from(context).inflate(R.layout.dropdown_item_qy,parent,false);
