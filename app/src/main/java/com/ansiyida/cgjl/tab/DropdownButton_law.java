 ...
 */
public class DropdownButton_law extends RelativeLayout implements Checkable, View.OnClickListener, PopWinDownUtil.OnDismissLisener, AdapterView.OnItemClickListener {
    /**
     * 菜单按钮文字内容
     */
    ...
    public DropdownButton_law(Context context) {
        this(context, null);
    }

    public DropdownButton_law(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DropdownButton_law(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        mContext = context;
        //菜单按钮的布局
        View view =  LayoutInflater.from(getContext()).inflate(R.layout.dropdown_tab_button_law,this, true);
