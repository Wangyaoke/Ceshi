 ...
 */
public class DropdownButton_dy extends RelativeLayout implements Checkable, View.OnClickListener, PopWinDownUtil.OnDismissLisener, AdapterView.OnItemClickListener {
    /**
     * 菜单按钮文字内容
     */
    ...
    public DropdownButton_dy(Context context) {
        this(context, null);
    }

    public DropdownButton_dy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DropdownButton_dy(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param dropBeans
     */
    public void setData(List<DropBean> dropBeans,String name){
        if(dropBeans == null)
            return;
