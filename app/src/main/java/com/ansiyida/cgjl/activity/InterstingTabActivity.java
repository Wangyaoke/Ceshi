...
public class InterstingTabActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    protected int getContentView() {
        return R.layout.activity_intersting_tab;
    }
    ...
    protected void httpData() {
        ...
        int interst_tab = mannager.getTableDataCount("interst_tab");
        LogUtil.i("tabCount", "tabCount:" + interst_tab);
        if (interst_tab > 0) {
            userChannelList = mannager.getChoiceItem("interst_tab");
            otherChannelList = mannager.getDefaultItem("interst_tab");
            userAdapter = new DragAdapter(InterstingTabActivity.this, userChannelList, userGridView.getFlag(), mannager, InterstingTabActivity.this, "interst_tab");
            userGridView.setAdapter(userAdapter);
            otherAdapter = new OtherAdapter(InterstingTabActivity.this, otherChannelList, "interst_tab");
            otherGridView.setAdapter(otherAdapter);
            //设置GRIDVIEW的ITEM的点击监听
            otherGridView.setOnItemClickListener(InterstingTabActivity.this);
            userGridView.setOnItemClickListener(InterstingTabActivity.this);
        } else {
            Call<JuBaoBean> call = MyApplication.getNetApi().getJuBao("5");
            call.enqueue(new Callback<JuBaoBean>() {
                ...
                public void onResponse(Call<JuBaoBean> call, Response<JuBaoBean> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (data != null) {
                            for (JuBaoBean.DataBean myBean : data) {
                                ChannelItem item = new ChannelItem(myBean.getJl_id(), myBean.getJl_id(), myBean.getJl_type() + "", myBean.getJl_name(), 0,0);
                        ...
                        ToastUtils.showMessage(InterstingTabActivity.this, "解析错误1");
                    }
                ...
                public void onFailure(Call<JuBaoBean> call, Throwable t) {
                    ToastUtils.showMessage(InterstingTabActivity.this, "解析错误2");
                    call.cancel();
